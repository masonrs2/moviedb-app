    ...
    <div className=" px-10 xl:px-32 py-8">
       <div className="flex flex-col">
          ...
          <div id={'slider'} className="flex gap-4 relative w-full overflow-x-scroll scroll-smooth scrollbar-hide group ">
              ...
              <MdChevronRight onClick={(movieRow) => rightSlider(movieRow)} className="bg-black top-[29%] right-20 rounded-full absolute opacity-50 hover:opacity-75 active:opacity-100 cursor-pointer z-10" size={40} />
       </div>
    </div>
  )
}
